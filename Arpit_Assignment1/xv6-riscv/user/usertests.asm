...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124a:	46a78793          	addi	a5,a5,1130 # 86b0 <big.1286>
...
0000000000002236 <bigargtest>:
{
  ...
  close(fd);
    ...
    229e:	31678793          	addi	a5,a5,790 # 85b0 <args.1875>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	40668693          	addi	a3,a3,1030 # 86a8 <args.1875+0xf8>
    ...
    22be:	2f658593          	addi	a1,a1,758 # 85b0 <args.1875>
