...
user/_forkf:     file format elf64-littleriscv
...
int f (void)
{
  ...
  10:	88c58593          	addi	a1,a1,-1908 # 898 <malloc+0xe8>
  14:	4509                	li	a0,2
  16:	00000097          	auipc	ra,0x0
  1a:	6ae080e7          	jalr	1710(ra) # 6c4 <fprintf>
   return 0;
}
  1e:	4501                	li	a0,0
  20:	60a2                	ld	ra,8(sp)
...
main(void)
{
  ...
  70:	86458593          	addi	a1,a1,-1948 # 8d0 <malloc+0x120>
  74:	4505                	li	a0,1
  76:	00000097          	auipc	ra,0x0
  7a:	64e080e7          	jalr	1614(ra) # 6c4 <fprintf>
     wait(0);
  7e:	4501                	li	a0,0
  ...
  96:	81e58593          	addi	a1,a1,-2018 # 8b0 <malloc+0x100>
  9a:	4509                	li	a0,2
  9c:	00000097          	auipc	ra,0x0
  a0:	628080e7          	jalr	1576(ra) # 6c4 <fprintf>
     exit(0);
  a4:	4501                	li	a0,0
  ...
  bc:	82858593          	addi	a1,a1,-2008 # 8e0 <malloc+0x130>
  c0:	4505                	li	a0,1
  c2:	00000097          	auipc	ra,0x0
  c6:	602080e7          	jalr	1538(ra) # 6c4 <fprintf>
...
putc(int fd, char c)
{
 ...
 430:	f36080e7          	jalr	-202(ra) # 362 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 462:	49a50513          	addi	a0,a0,1178 # 8f8 <digits>
 466:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 66e:	28690913          	addi	s2,s2,646 # 8f0 <malloc+0x140>
        while(*s != 0){
...
free(void *ap)
{
 ...
 736:	1de7b783          	ld	a5,478(a5) # 910 <freep>
 ...
 764:	00e6ea63          	bltu	a3,a4,778 <free+0x50>
{
 ...
 7a6:	16f73723          	sd	a5,366(a4) # 910 <freep>
}
 7aa:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d8:	13c53503          	ld	a0,316(a0) # 910 <freep>
 ...
 800:	11490913          	addi	s2,s2,276 # 910 <freep>
  if(p == (char*)-1)
 804:	5afd                	li	s5,-1
 806:	a88d                	j	878 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 808:	00000797          	auipc	a5,0x0
 80c:	11078793          	addi	a5,a5,272 # 918 <base>
 810:	00000717          	auipc	a4,0x0
 814:	10f73023          	sd	a5,256(a4) # 910 <freep>
 818:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83a:	0ca73d23          	sd	a0,218(a4) # 910 <freep>
      return (void*)(p + 1);
 ...
 888:	b46080e7          	jalr	-1210(ra) # 3ca <sbrk>
  if(p == (char*)-1)
